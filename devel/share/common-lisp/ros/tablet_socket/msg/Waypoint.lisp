...
(cl:defmethod cl:initialize-instance :after ((m <Waypoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Waypoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tablet_socket-msg:<Waypoint> is deprecated: use tablet_socket-msg:Waypoint instead.")))

(cl:ensure-generic-function 'lat-val :lambda-list '(m))
(cl:defmethod lat-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tablet_socket-msg:lat-val is deprecated.  Use tablet_socket-msg:lat instead.")
  (lat m))

(cl:ensure-generic-function 'lon-val :lambda-list '(m))
(cl:defmethod lon-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tablet_socket-msg:lon-val is deprecated.  Use tablet_socket-msg:lon instead.")
  (lon m))
