...
(cl:defmethod cl:initialize-instance :after ((m <mode_cmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'mode_cmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tablet_socket-msg:<mode_cmd> is deprecated: use tablet_socket-msg:mode_cmd instead.")))
