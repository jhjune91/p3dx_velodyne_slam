...
(cl:defmethod cl:initialize-instance :after ((m <mode_info>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'mode_info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tablet_socket-msg:<mode_info> is deprecated: use tablet_socket-msg:mode_info instead.")))
...
(cl:defmethod mode-val ((m <mode_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tablet_socket-msg:mode-val is deprecated.  Use tablet_socket-msg:mode instead.")
  (mode m))
