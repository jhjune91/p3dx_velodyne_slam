...
(cl:in-package tablet_socket-msg)
...
(cl:defclass <route_cmd> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (point
    :reader point
    :initarg :point
    :type (cl:vector tablet_socket-msg:Waypoint)
   :initform (cl:make-array 0 :element-type 'tablet_socket-msg:Waypoint :initial-element (cl:make-instance 'tablet_socket-msg:Waypoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <route_cmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'route_cmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tablet_socket-msg:<route_cmd> is deprecated: use tablet_socket-msg:route_cmd instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <route_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tablet_socket-msg:header-val is deprecated.  Use tablet_socket-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'point-val :lambda-list '(m))
(cl:defmethod point-val ((m <route_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tablet_socket-msg:point-val is deprecated.  Use tablet_socket-msg:point instead.")
  (point m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <route_cmd>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'point)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'tablet_socket-msg:Waypoint))
