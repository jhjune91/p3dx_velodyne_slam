...
(cl:defmethod cl:initialize-instance :after ((m <gear_cmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'gear_cmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tablet_socket-msg:<gear_cmd> is deprecated: use tablet_socket-msg:gear_cmd instead.")))
...
(cl:defmethod gear-val ((m <gear_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tablet_socket-msg:gear-val is deprecated.  Use tablet_socket-msg:gear instead.")
  (gear m))
