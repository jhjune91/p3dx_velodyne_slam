...
(cl:defmethod cl:initialize-instance :after ((m <error_info>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'error_info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tablet_socket-msg:<error_info> is deprecated: use tablet_socket-msg:error_info instead.")))
...
(cl:defmethod error-val ((m <error_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tablet_socket-msg:error-val is deprecated.  Use tablet_socket-msg:error instead.")
  (error m))
