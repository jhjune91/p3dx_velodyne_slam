...
(cl:defmethod cl:initialize-instance :after ((m <ImageLaneObjects>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageLaneObjects)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lane_detector-msg:<ImageLaneObjects> is deprecated: use lane_detector-msg:ImageLaneObjects instead.")))
...
(cl:defmethod lane_l_x1-val ((m <ImageLaneObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_detector-msg:lane_l_x1-val is deprecated.  Use lane_detector-msg:lane_l_x1 instead.")
  (lane_l_x1 m))

(cl:ensure-generic-function 'lane_l_y1-val :lambda-list '(m))
(cl:defmethod lane_l_y1-val ((m <ImageLaneObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_detector-msg:lane_l_y1-val is deprecated.  Use lane_detector-msg:lane_l_y1 instead.")
  (lane_l_y1 m))

(cl:ensure-generic-function 'lane_l_x2-val :lambda-list '(m))
(cl:defmethod lane_l_x2-val ((m <ImageLaneObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_detector-msg:lane_l_x2-val is deprecated.  Use lane_detector-msg:lane_l_x2 instead.")
  (lane_l_x2 m))

(cl:ensure-generic-function 'lane_l_y2-val :lambda-list '(m))
(cl:defmethod lane_l_y2-val ((m <ImageLaneObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_detector-msg:lane_l_y2-val is deprecated.  Use lane_detector-msg:lane_l_y2 instead.")
  (lane_l_y2 m))

(cl:ensure-generic-function 'lane_r_x1-val :lambda-list '(m))
(cl:defmethod lane_r_x1-val ((m <ImageLaneObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_detector-msg:lane_r_x1-val is deprecated.  Use lane_detector-msg:lane_r_x1 instead.")
  (lane_r_x1 m))

(cl:ensure-generic-function 'lane_r_y1-val :lambda-list '(m))
(cl:defmethod lane_r_y1-val ((m <ImageLaneObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_detector-msg:lane_r_y1-val is deprecated.  Use lane_detector-msg:lane_r_y1 instead.")
  (lane_r_y1 m))

(cl:ensure-generic-function 'lane_r_x2-val :lambda-list '(m))
(cl:defmethod lane_r_x2-val ((m <ImageLaneObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_detector-msg:lane_r_x2-val is deprecated.  Use lane_detector-msg:lane_r_x2 instead.")
  (lane_r_x2 m))

(cl:ensure-generic-function 'lane_r_y2-val :lambda-list '(m))
(cl:defmethod lane_r_y2-val ((m <ImageLaneObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_detector-msg:lane_r_y2-val is deprecated.  Use lane_detector-msg:lane_r_y2 instead.")
  (lane_r_y2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ImageLaneObjects>)))
  ...
  "lane_detector/ImageLaneObjects")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ImageLaneObjects)))
  "Returns string type for a message object of type 'ImageLaneObjects"
  "lane_detector/ImageLaneObjects")
