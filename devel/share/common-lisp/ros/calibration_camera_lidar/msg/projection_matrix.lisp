...
(cl:in-package calibration_camera_lidar-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <projection_matrix>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'projection_matrix)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name calibration_camera_lidar-msg:<projection_matrix> is deprecated: use calibration_camera_lidar-msg:projection_matrix instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <projection_matrix>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader calibration_camera_lidar-msg:header-val is deprecated.  Use calibration_camera_lidar-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'projection_matrix-val :lambda-list '(m))
(cl:defmethod projection_matrix-val ((m <projection_matrix>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader calibration_camera_lidar-msg:projection_matrix-val is deprecated.  Use calibration_camera_lidar-msg:projection_matrix instead.")
  (projection_matrix m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<projection_matrix>)))
  ...
  "calibration_camera_lidar/projection_matrix")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'projection_matrix)))
  "Returns string type for a message object of type 'projection_matrix"
  "calibration_camera_lidar/projection_matrix")
