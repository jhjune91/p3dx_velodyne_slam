...
(cl:in-package pioneer3_control_ros-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <BumperState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BumperState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pioneer3_control_ros-msg:<BumperState> is deprecated: use pioneer3_control_ros-msg:BumperState instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <BumperState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pioneer3_control_ros-msg:header-val is deprecated.  Use pioneer3_control_ros-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'front_bumpers-val :lambda-list '(m))
(cl:defmethod front_bumpers-val ((m <BumperState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pioneer3_control_ros-msg:front_bumpers-val is deprecated.  Use pioneer3_control_ros-msg:front_bumpers instead.")
  (front_bumpers m))

(cl:ensure-generic-function 'rear_bumpers-val :lambda-list '(m))
(cl:defmethod rear_bumpers-val ((m <BumperState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pioneer3_control_ros-msg:rear_bumpers-val is deprecated.  Use pioneer3_control_ros-msg:rear_bumpers instead.")
  (rear_bumpers m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BumperState>)))
  ...
  "pioneer3_control_ros/BumperState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BumperState)))
  "Returns string type for a message object of type 'BumperState"
  "pioneer3_control_ros/BumperState")
