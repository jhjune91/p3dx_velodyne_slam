...
(cl:defmethod cl:initialize-instance :after ((m <ImageObjects>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageObjects)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name libdpm_ocv-msg:<ImageObjects> is deprecated: use libdpm_ocv-msg:ImageObjects instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ImageObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader libdpm_ocv-msg:header-val is deprecated.  Use libdpm_ocv-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'car_num-val :lambda-list '(m))
(cl:defmethod car_num-val ((m <ImageObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader libdpm_ocv-msg:car_num-val is deprecated.  Use libdpm_ocv-msg:car_num instead.")
  (car_num m))

(cl:ensure-generic-function 'car_type-val :lambda-list '(m))
(cl:defmethod car_type-val ((m <ImageObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader libdpm_ocv-msg:car_type-val is deprecated.  Use libdpm_ocv-msg:car_type instead.")
  (car_type m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <ImageObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader libdpm_ocv-msg:score-val is deprecated.  Use libdpm_ocv-msg:score instead.")
  (score m))

(cl:ensure-generic-function 'corner_point-val :lambda-list '(m))
(cl:defmethod corner_point-val ((m <ImageObjects>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader libdpm_ocv-msg:corner_point-val is deprecated.  Use libdpm_ocv-msg:corner_point instead.")
  (corner_point m))
