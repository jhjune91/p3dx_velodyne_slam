...
(cl:in-package synchronization-msg)


;//! \htmlinclude time_monitor.msg.html

(cl:defclass <time_monitor> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass time_monitor (<time_monitor>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <time_monitor>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'time_monitor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name synchronization-msg:<time_monitor> is deprecated: use synchronization-msg:time_monitor instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <time_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader synchronization-msg:header-val is deprecated.  Use synchronization-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'image_raw-val :lambda-list '(m))
(cl:defmethod image_raw-val ((m <time_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader synchronization-msg:image_raw-val is deprecated.  Use synchronization-msg:image_raw instead.")
  (image_raw m))

(cl:ensure-generic-function 'points_raw-val :lambda-list '(m))
(cl:defmethod points_raw-val ((m <time_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader synchronization-msg:points_raw-val is deprecated.  Use synchronization-msg:points_raw instead.")
  (points_raw m))

(cl:ensure-generic-function 'points_image-val :lambda-list '(m))
(cl:defmethod points_image-val ((m <time_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader synchronization-msg:points_image-val is deprecated.  Use synchronization-msg:points_image instead.")
  (points_image m))

(cl:ensure-generic-function 'vscan_points-val :lambda-list '(m))
(cl:defmethod vscan_points-val ((m <time_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader synchronization-msg:vscan_points-val is deprecated.  Use synchronization-msg:vscan_points instead.")
  (vscan_points m))

(cl:ensure-generic-function 'vscan_image-val :lambda-list '(m))
(cl:defmethod vscan_image-val ((m <time_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader synchronization-msg:vscan_image-val is deprecated.  Use synchronization-msg:vscan_image instead.")
  (vscan_image m))

(cl:ensure-generic-function 'image_obj-val :lambda-list '(m))
(cl:defmethod image_obj-val ((m <time_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader synchronization-msg:image_obj-val is deprecated.  Use synchronization-msg:image_obj instead.")
  (image_obj m))

(cl:ensure-generic-function 'image_obj_ranged-val :lambda-list '(m))
(cl:defmethod image_obj_ranged-val ((m <time_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader synchronization-msg:image_obj_ranged-val is deprecated.  Use synchronization-msg:image_obj_ranged instead.")
  (image_obj_ranged m))

(cl:ensure-generic-function 'image_obj_tracked-val :lambda-list '(m))
(cl:defmethod image_obj_tracked-val ((m <time_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader synchronization-msg:image_obj_tracked-val is deprecated.  Use synchronization-msg:image_obj_tracked instead.")
  (image_obj_tracked m))

(cl:ensure-generic-function 'current_pose-val :lambda-list '(m))
(cl:defmethod current_pose-val ((m <time_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader synchronization-msg:current_pose-val is deprecated.  Use synchronization-msg:current_pose instead.")
  (current_pose m))

(cl:ensure-generic-function 'obj_label-val :lambda-list '(m))
(cl:defmethod obj_label-val ((m <time_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader synchronization-msg:obj_label-val is deprecated.  Use synchronization-msg:obj_label instead.")
  (obj_label m))

(cl:ensure-generic-function 'cluster_centroids-val :lambda-list '(m))
(cl:defmethod cluster_centroids-val ((m <time_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader synchronization-msg:cluster_centroids-val is deprecated.  Use synchronization-msg:cluster_centroids instead.")
  (cluster_centroids m))

(cl:ensure-generic-function 'obj_pose-val :lambda-list '(m))
(cl:defmethod obj_pose-val ((m <time_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader synchronization-msg:obj_pose-val is deprecated.  Use synchronization-msg:obj_pose instead.")
  (obj_pose m))

(cl:ensure-generic-function 'execution_time-val :lambda-list '(m))
(cl:defmethod execution_time-val ((m <time_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader synchronization-msg:execution_time-val is deprecated.  Use synchronization-msg:execution_time instead.")
  (execution_time m))

(cl:ensure-generic-function 'cycle_time-val :lambda-list '(m))
(cl:defmethod cycle_time-val ((m <time_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader synchronization-msg:cycle_time-val is deprecated.  Use synchronization-msg:cycle_time instead.")
  (cycle_time m))

(cl:ensure-generic-function 'time_diff-val :lambda-list '(m))
(cl:defmethod time_diff-val ((m <time_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader synchronization-msg:time_diff-val is deprecated.  Use synchronization-msg:time_diff instead.")
  (time_diff m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <time_monitor>) ostream)
  "Serializes a message object of type '<time_monitor>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <time_monitor>) istream)
  "Deserializes a message object of type '<time_monitor>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<time_monitor>)))
  "Returns string type for a message object of type '<time_monitor>"
  "synchronization/time_monitor")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'time_monitor)))
  "Returns string type for a message object of type 'time_monitor"
  "synchronization/time_monitor")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<time_monitor>)))
  "Returns md5sum for a message object of type '<time_monitor>"
  "8c6a4dd195d4ccc31d38fad617327689")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'time_monitor)))
  "Returns md5sum for a message object of type 'time_monitor"
  "8c6a4dd195d4ccc31d38fad617327689")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<time_monitor>)))
  "Returns full string definition for message of type '<time_monitor>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'time_monitor)))
  "Returns full string definition for message of type 'time_monitor"
  (cl:format cl:nil "Header header~%float64 image_raw~%float64 points_raw~%float64 points_image~%float64 vscan_points~%float64 vscan_image~%float64 image_obj~%float64 image_obj_ranged~%float64 image_obj_tracked~%float64 current_pose~%float64 obj_label~%float64 cluster_centroids~%float64 obj_pose~%float64 execution_time~%float64 cycle_time~%float64 time_diff~%~%~%# time image_raw~%# time points_raw~%# time image_obj~%# time image_obj_ranged~%# time image_obj_tracked~%# time current_pose~%# time obj_label~%# time cluster_centroids~%# time obj_pose~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <time_monitor>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <time_monitor>))
  "Converts a ROS message object to a list"
  (cl:list 'time_monitor
