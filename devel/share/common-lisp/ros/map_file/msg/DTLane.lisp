...
(cl:defmethod cl:initialize-instance :after ((m <DTLane>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DTLane)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map_file-msg:<DTLane> is deprecated: use map_file-msg:DTLane instead.")))
...
(cl:defmethod dist-val ((m <DTLane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_file-msg:dist-val is deprecated.  Use map_file-msg:dist instead.")
  (dist m))
...
(cl:defmethod dir-val ((m <DTLane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_file-msg:dir-val is deprecated.  Use map_file-msg:dir instead.")
  (dir m))

(cl:ensure-generic-function 'apara-val :lambda-list '(m))
(cl:defmethod apara-val ((m <DTLane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_file-msg:apara-val is deprecated.  Use map_file-msg:apara instead.")
  (apara m))

(cl:ensure-generic-function 'r-val :lambda-list '(m))
(cl:defmethod r-val ((m <DTLane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_file-msg:r-val is deprecated.  Use map_file-msg:r instead.")
  (r m))

(cl:ensure-generic-function 'slope-val :lambda-list '(m))
(cl:defmethod slope-val ((m <DTLane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_file-msg:slope-val is deprecated.  Use map_file-msg:slope instead.")
  (slope m))

(cl:ensure-generic-function 'cant-val :lambda-list '(m))
(cl:defmethod cant-val ((m <DTLane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_file-msg:cant-val is deprecated.  Use map_file-msg:cant instead.")
  (cant m))

(cl:ensure-generic-function 'lw-val :lambda-list '(m))
(cl:defmethod lw-val ((m <DTLane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_file-msg:lw-val is deprecated.  Use map_file-msg:lw instead.")
  (lw m))

(cl:ensure-generic-function 'rw-val :lambda-list '(m))
(cl:defmethod rw-val ((m <DTLane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_file-msg:rw-val is deprecated.  Use map_file-msg:rw instead.")
  (rw m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DTLane>)))
  ...
  (cl:format cl:nil "int32 did~%float64 dist~%int32 pid~%float64 dir~%float64 apara~%float64 r~%float64 slope~%float64 cant~%float64 lw~%float64 rw~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DTLane)))
  "Returns full string definition for message of type 'DTLane"
  (cl:format cl:nil "int32 did~%float64 dist~%int32 pid~%float64 dir~%float64 apara~%float64 r~%float64 slope~%float64 cant~%float64 lw~%float64 rw~%~%~%"))
