...
(cl:defmethod cl:initialize-instance :after ((m <StopLine>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StopLine)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map_file-msg:<StopLine> is deprecated: use map_file-msg:StopLine instead.")))
...
(cl:defmethod tlid-val ((m <StopLine>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_file-msg:tlid-val is deprecated.  Use map_file-msg:tlid instead.")
  (tlid m))

(cl:ensure-generic-function 'signid-val :lambda-list '(m))
(cl:defmethod signid-val ((m <StopLine>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_file-msg:signid-val is deprecated.  Use map_file-msg:signid instead.")
  (signid m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<StopLine>)))
  ...
  (cl:format cl:nil "int32 id~%int32 lid~%int32 tlid~%int32 signid~%int32 linkid~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'StopLine)))
  "Returns full string definition for message of type 'StopLine"
  (cl:format cl:nil "int32 id~%int32 lid~%int32 tlid~%int32 signid~%int32 linkid~%~%~%"))
