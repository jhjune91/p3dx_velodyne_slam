...
(defsystem "map_file-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "PoleClassArray" :depends-on ("_package_PoleClassArray"))
    (:file "_package_PoleClassArray" :depends-on ("_package"))
    (:file "CrossRoadArray" :depends-on ("_package_CrossRoadArray"))
    (:file "_package_CrossRoadArray" :depends-on ("_package"))
    (:file "VectorClass" :depends-on ("_package_VectorClass"))
    (:file "_package_VectorClass" :depends-on ("_package"))
    ...
    (:file "BoxClassArray" :depends-on ("_package_BoxClassArray"))
    (:file "_package_BoxClassArray" :depends-on ("_package"))
    (:file "PointClass" :depends-on ("_package_PointClass"))
    (:file "_package_PointClass" :depends-on ("_package"))
    (:file "RoadMark" :depends-on ("_package_RoadMark"))
    (:file "_package_RoadMark" :depends-on ("_package"))
    (:file "PoleClass" :depends-on ("_package_PoleClass"))
    (:file "_package_PoleClass" :depends-on ("_package"))
    ...
    (:file "LineClass" :depends-on ("_package_LineClass"))
    (:file "_package_LineClass" :depends-on ("_package"))
    (:file "StopLine" :depends-on ("_package_StopLine"))
    (:file "_package_StopLine" :depends-on ("_package"))
    (:file "AreaClass" :depends-on ("_package_AreaClass"))
    (:file "_package_AreaClass" :depends-on ("_package"))
    (:file "VectorClassArray" :depends-on ("_package_VectorClassArray"))
    (:file "_package_VectorClassArray" :depends-on ("_package"))
    ...
    (:file "AreaClassArray" :depends-on ("_package_AreaClassArray"))
    (:file "_package_AreaClassArray" :depends-on ("_package"))
    ...
    (:file "PointClassArray" :depends-on ("_package_PointClassArray"))
    (:file "_package_PointClassArray" :depends-on ("_package"))
    (:file "Pole" :depends-on ("_package_Pole"))
    (:file "_package_Pole" :depends-on ("_package"))
    (:file "BoxClass" :depends-on ("_package_BoxClass"))
    (:file "_package_BoxClass" :depends-on ("_package"))
    ...
    (:file "LineClassArray" :depends-on ("_package_LineClassArray"))
    (:file "_package_LineClassArray" :depends-on ("_package"))
