...
(cl:defmethod cl:initialize-instance :after ((m <UtilityPole>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UtilityPole)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map_file-msg:<UtilityPole> is deprecated: use map_file-msg:UtilityPole instead.")))
