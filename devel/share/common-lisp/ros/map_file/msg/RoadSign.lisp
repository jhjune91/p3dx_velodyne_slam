...
(cl:defmethod cl:initialize-instance :after ((m <RoadSign>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RoadSign)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map_file-msg:<RoadSign> is deprecated: use map_file-msg:RoadSign instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RoadSign>)))
  ...
  (cl:format cl:nil "int32 id~%int32 vid~%int32 plid~%int32 type # Don't use wide character~%int32 linkid~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RoadSign)))
  "Returns full string definition for message of type 'RoadSign"
  (cl:format cl:nil "int32 id~%int32 vid~%int32 plid~%int32 type # Don't use wide character~%int32 linkid~%~%~%"))
