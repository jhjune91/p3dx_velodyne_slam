...
(cl:defmethod cl:initialize-instance :after ((m <ConfigRcnn>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigRcnn)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name runtime_manager-msg:<ConfigRcnn> is deprecated: use runtime_manager-msg:ConfigRcnn instead.")))
...
(cl:defmethod score_threshold-val ((m <ConfigRcnn>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:score_threshold-val is deprecated.  Use runtime_manager-msg:score_threshold instead.")
  (score_threshold m))

(cl:ensure-generic-function 'group_threshold-val :lambda-list '(m))
(cl:defmethod group_threshold-val ((m <ConfigRcnn>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:group_threshold-val is deprecated.  Use runtime_manager-msg:group_threshold instead.")
  (group_threshold m))

(cl:ensure-generic-function 'slices_overlap-val :lambda-list '(m))
(cl:defmethod slices_overlap-val ((m <ConfigRcnn>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:slices_overlap-val is deprecated.  Use runtime_manager-msg:slices_overlap instead.")
  (slices_overlap m))

(cl:ensure-generic-function 'b_mean-val :lambda-list '(m))
(cl:defmethod b_mean-val ((m <ConfigRcnn>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:b_mean-val is deprecated.  Use runtime_manager-msg:b_mean instead.")
  (b_mean m))

(cl:ensure-generic-function 'g_mean-val :lambda-list '(m))
(cl:defmethod g_mean-val ((m <ConfigRcnn>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:g_mean-val is deprecated.  Use runtime_manager-msg:g_mean instead.")
  (g_mean m))

(cl:ensure-generic-function 'r_mean-val :lambda-list '(m))
(cl:defmethod r_mean-val ((m <ConfigRcnn>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:r_mean-val is deprecated.  Use runtime_manager-msg:r_mean instead.")
  (r_mean m))

(cl:ensure-generic-function 'image_slices-val :lambda-list '(m))
(cl:defmethod image_slices-val ((m <ConfigRcnn>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:image_slices-val is deprecated.  Use runtime_manager-msg:image_slices instead.")
  (image_slices m))

(cl:ensure-generic-function 'use_gpu-val :lambda-list '(m))
(cl:defmethod use_gpu-val ((m <ConfigRcnn>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:use_gpu-val is deprecated.  Use runtime_manager-msg:use_gpu instead.")
  (use_gpu m))

(cl:ensure-generic-function 'gpu_device_id-val :lambda-list '(m))
(cl:defmethod gpu_device_id-val ((m <ConfigRcnn>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:gpu_device_id-val is deprecated.  Use runtime_manager-msg:gpu_device_id instead.")
  (gpu_device_id m))
