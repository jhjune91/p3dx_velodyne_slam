...
(cl:defmethod cl:initialize-instance :after ((m <accel_cmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'accel_cmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name runtime_manager-msg:<accel_cmd> is deprecated: use runtime_manager-msg:accel_cmd instead.")))
...
(cl:defmethod accel-val ((m <accel_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:accel-val is deprecated.  Use runtime_manager-msg:accel instead.")
  (accel m))
