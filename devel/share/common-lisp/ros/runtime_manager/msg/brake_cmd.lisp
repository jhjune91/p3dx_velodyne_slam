...
(cl:defmethod cl:initialize-instance :after ((m <brake_cmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'brake_cmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name runtime_manager-msg:<brake_cmd> is deprecated: use runtime_manager-msg:brake_cmd instead.")))
...
(cl:defmethod brake-val ((m <brake_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:brake-val is deprecated.  Use runtime_manager-msg:brake instead.")
  (brake m))
