...
(cl:defmethod cl:initialize-instance :after ((m <lamp_cmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lamp_cmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name runtime_manager-msg:<lamp_cmd> is deprecated: use runtime_manager-msg:lamp_cmd instead.")))
