...
(cl:defmethod cl:initialize-instance :after ((m <ConfigTwistFilter>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigTwistFilter)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name runtime_manager-msg:<ConfigTwistFilter> is deprecated: use runtime_manager-msg:ConfigTwistFilter instead.")))
...
(cl:defmethod lateral_accel_limit-val ((m <ConfigTwistFilter>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:lateral_accel_limit-val is deprecated.  Use runtime_manager-msg:lateral_accel_limit instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigTwistFilter>)))
  ...
  "runtime_manager/ConfigTwistFilter")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigTwistFilter)))
  "Returns string type for a message object of type 'ConfigTwistFilter"
  "runtime_manager/ConfigTwistFilter")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ConfigTwistFilter>)))
  ...
  "152ca986ecec8d9c245edaa8b61fdb78")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ConfigTwistFilter)))
  "Returns md5sum for a message object of type 'ConfigTwistFilter"
  "152ca986ecec8d9c245edaa8b61fdb78")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ConfigTwistFilter>)))
  ...
  (cl:format cl:nil "Header header~%float32 lateral_accel_limit~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ConfigTwistFilter)))
  "Returns full string definition for message of type 'ConfigTwistFilter"
  (cl:format cl:nil "Header header~%float32 lateral_accel_limit~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
