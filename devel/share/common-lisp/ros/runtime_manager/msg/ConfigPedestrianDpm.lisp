...
(cl:defmethod cl:initialize-instance :after ((m <ConfigPedestrianDpm>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigPedestrianDpm)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name runtime_manager-msg:<ConfigPedestrianDpm> is deprecated: use runtime_manager-msg:ConfigPedestrianDpm instead.")))
...
(cl:defmethod Lambda-val ((m <ConfigPedestrianDpm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:Lambda-val is deprecated.  Use runtime_manager-msg:Lambda instead.")
  (Lambda m))

(cl:ensure-generic-function 'num_cells-val :lambda-list '(m))
(cl:defmethod num_cells-val ((m <ConfigPedestrianDpm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:num_cells-val is deprecated.  Use runtime_manager-msg:num_cells instead.")
  (num_cells m))

(cl:ensure-generic-function 'num_bins-val :lambda-list '(m))
(cl:defmethod num_bins-val ((m <ConfigPedestrianDpm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:num_bins-val is deprecated.  Use runtime_manager-msg:num_bins instead.")
  (num_bins m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigPedestrianDpm>)))
  ...
  "runtime_manager/ConfigPedestrianDpm")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigPedestrianDpm)))
  "Returns string type for a message object of type 'ConfigPedestrianDpm"
  "runtime_manager/ConfigPedestrianDpm")
