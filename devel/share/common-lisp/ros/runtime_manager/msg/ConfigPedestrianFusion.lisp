...
(cl:defmethod cl:initialize-instance :after ((m <ConfigPedestrianFusion>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigPedestrianFusion)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name runtime_manager-msg:<ConfigPedestrianFusion> is deprecated: use runtime_manager-msg:ConfigPedestrianFusion instead.")))
...
(cl:defmethod min_low_height-val ((m <ConfigPedestrianFusion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:min_low_height-val is deprecated.  Use runtime_manager-msg:min_low_height instead.")
  (min_low_height m))

(cl:ensure-generic-function 'max_low_height-val :lambda-list '(m))
(cl:defmethod max_low_height-val ((m <ConfigPedestrianFusion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:max_low_height-val is deprecated.  Use runtime_manager-msg:max_low_height instead.")
  (max_low_height m))

(cl:ensure-generic-function 'max_height-val :lambda-list '(m))
(cl:defmethod max_height-val ((m <ConfigPedestrianFusion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:max_height-val is deprecated.  Use runtime_manager-msg:max_height instead.")
  (max_height m))

(cl:ensure-generic-function 'min_points-val :lambda-list '(m))
(cl:defmethod min_points-val ((m <ConfigPedestrianFusion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:min_points-val is deprecated.  Use runtime_manager-msg:min_points instead.")
  (min_points m))

(cl:ensure-generic-function 'dispersion-val :lambda-list '(m))
(cl:defmethod dispersion-val ((m <ConfigPedestrianFusion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:dispersion-val is deprecated.  Use runtime_manager-msg:dispersion instead.")
  (dispersion m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigPedestrianFusion>)))
  ...
  "runtime_manager/ConfigPedestrianFusion")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigPedestrianFusion)))
  "Returns string type for a message object of type 'ConfigPedestrianFusion"
  "runtime_manager/ConfigPedestrianFusion")
