...
(cl:defmethod cl:initialize-instance :after ((m <adjust_xy>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'adjust_xy)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name runtime_manager-msg:<adjust_xy> is deprecated: use runtime_manager-msg:adjust_xy instead.")))
