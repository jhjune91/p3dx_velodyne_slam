...
(cl:defmethod cl:initialize-instance :after ((m <indicator_cmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'indicator_cmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name runtime_manager-msg:<indicator_cmd> is deprecated: use runtime_manager-msg:indicator_cmd instead.")))
...
(cl:defmethod l-val ((m <indicator_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:l-val is deprecated.  Use runtime_manager-msg:l instead.")
  (l m))

(cl:ensure-generic-function 'r-val :lambda-list '(m))
(cl:defmethod r-val ((m <indicator_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:r-val is deprecated.  Use runtime_manager-msg:r instead.")
  (r m))
