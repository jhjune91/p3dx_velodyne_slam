...
(cl:defmethod cl:initialize-instance :after ((m <steer_cmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'steer_cmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name runtime_manager-msg:<steer_cmd> is deprecated: use runtime_manager-msg:steer_cmd instead.")))
...
(cl:defmethod steer-val ((m <steer_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:steer-val is deprecated.  Use runtime_manager-msg:steer instead.")
  (steer m))
