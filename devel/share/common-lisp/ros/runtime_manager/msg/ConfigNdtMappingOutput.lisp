...
(cl:defmethod cl:initialize-instance :after ((m <ConfigNdtMappingOutput>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigNdtMappingOutput)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name runtime_manager-msg:<ConfigNdtMappingOutput> is deprecated: use runtime_manager-msg:ConfigNdtMappingOutput instead.")))
...
(cl:defmethod filename-val ((m <ConfigNdtMappingOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:filename-val is deprecated.  Use runtime_manager-msg:filename instead.")
  (filename m))

(cl:ensure-generic-function 'filter_res-val :lambda-list '(m))
(cl:defmethod filter_res-val ((m <ConfigNdtMappingOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:filter_res-val is deprecated.  Use runtime_manager-msg:filter_res instead.")
  (filter_res m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigNdtMappingOutput>)))
  ...
  "runtime_manager/ConfigNdtMappingOutput")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigNdtMappingOutput)))
  "Returns string type for a message object of type 'ConfigNdtMappingOutput"
  "runtime_manager/ConfigNdtMappingOutput")
