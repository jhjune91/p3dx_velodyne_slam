...
(cl:defmethod cl:initialize-instance :after ((m <traffic_light>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'traffic_light)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name runtime_manager-msg:<traffic_light> is deprecated: use runtime_manager-msg:traffic_light instead.")))
...
(cl:defmethod traffic_light-val ((m <traffic_light>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:traffic_light-val is deprecated.  Use runtime_manager-msg:traffic_light instead.")
  (traffic_light m))
