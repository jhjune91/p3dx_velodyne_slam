...
(cl:defmethod cl:initialize-instance :after ((m <ConfigLaneStop>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigLaneStop)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name runtime_manager-msg:<ConfigLaneStop> is deprecated: use runtime_manager-msg:ConfigLaneStop instead.")))
...
(cl:defmethod manual_detection-val ((m <ConfigLaneStop>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader runtime_manager-msg:manual_detection-val is deprecated.  Use runtime_manager-msg:manual_detection instead.")
  (manual_detection m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigLaneStop>)))
  ...
  "runtime_manager/ConfigLaneStop")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigLaneStop)))
  "Returns string type for a message object of type 'ConfigLaneStop"
  "runtime_manager/ConfigLaneStop")
