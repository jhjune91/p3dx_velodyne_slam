...
(cl:in-package icp_localizer-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <icp_stat>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'icp_stat)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name icp_localizer-msg:<icp_stat> is deprecated: use icp_localizer-msg:icp_stat instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <icp_stat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icp_localizer-msg:header-val is deprecated.  Use icp_localizer-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'exe_time-val :lambda-list '(m))
(cl:defmethod exe_time-val ((m <icp_stat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icp_localizer-msg:exe_time-val is deprecated.  Use icp_localizer-msg:exe_time instead.")
  (exe_time m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <icp_stat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icp_localizer-msg:score-val is deprecated.  Use icp_localizer-msg:score instead.")
  (score m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <icp_stat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icp_localizer-msg:velocity-val is deprecated.  Use icp_localizer-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'acceleration-val :lambda-list '(m))
(cl:defmethod acceleration-val ((m <icp_stat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icp_localizer-msg:acceleration-val is deprecated.  Use icp_localizer-msg:acceleration instead.")
  (acceleration m))

(cl:ensure-generic-function 'use_predict_pose-val :lambda-list '(m))
(cl:defmethod use_predict_pose-val ((m <icp_stat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icp_localizer-msg:use_predict_pose-val is deprecated.  Use icp_localizer-msg:use_predict_pose instead.")
  (use_predict_pose m))
