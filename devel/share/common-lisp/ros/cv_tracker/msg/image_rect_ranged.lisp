...
(cl:defclass <image_rect_ranged> (roslisp-msg-protocol:ros-message)
  ((rect
    :reader rect
    :initarg :rect
    :type cv_tracker-msg:image_rect
    :initform (cl:make-instance 'cv_tracker-msg:image_rect))
   (range
    :reader range
    :initarg :range
    :type cl:float
...
(cl:defmethod cl:initialize-instance :after ((m <image_rect_ranged>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'image_rect_ranged)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cv_tracker-msg:<image_rect_ranged> is deprecated: use cv_tracker-msg:image_rect_ranged instead.")))

(cl:ensure-generic-function 'rect-val :lambda-list '(m))
(cl:defmethod rect-val ((m <image_rect_ranged>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_tracker-msg:rect-val is deprecated.  Use cv_tracker-msg:rect instead.")
  (rect m))

(cl:ensure-generic-function 'range-val :lambda-list '(m))
(cl:defmethod range-val ((m <image_rect_ranged>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_tracker-msg:range-val is deprecated.  Use cv_tracker-msg:range instead.")
  (range m))

(cl:ensure-generic-function 'min_height-val :lambda-list '(m))
(cl:defmethod min_height-val ((m <image_rect_ranged>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_tracker-msg:min_height-val is deprecated.  Use cv_tracker-msg:min_height instead.")
  (min_height m))

(cl:ensure-generic-function 'max_height-val :lambda-list '(m))
(cl:defmethod max_height-val ((m <image_rect_ranged>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_tracker-msg:max_height-val is deprecated.  Use cv_tracker-msg:max_height instead.")
  (max_height m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<image_rect_ranged>)))
  ...
  (cl:format cl:nil "image_rect rect~%float32 range~%float32 min_height~%float32 max_height~%~%================================================================================~%MSG: cv_tracker/image_rect~%int32 x~%int32 y~%int32 height~%int32 width~%float32 score~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'image_rect_ranged)))
  "Returns full string definition for message of type 'image_rect_ranged"
  (cl:format cl:nil "image_rect rect~%float32 range~%float32 min_height~%float32 max_height~%~%================================================================================~%MSG: cv_tracker/image_rect~%int32 x~%int32 y~%int32 height~%int32 width~%float32 score~%~%~%"))
