...
(cl:defmethod cl:initialize-instance :after ((m <image_obj_ranged>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'image_obj_ranged)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cv_tracker-msg:<image_obj_ranged> is deprecated: use cv_tracker-msg:image_obj_ranged instead.")))
...
(cl:defmethod obj-val ((m <image_obj_ranged>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_tracker-msg:obj-val is deprecated.  Use cv_tracker-msg:obj instead.")
  (obj m))
