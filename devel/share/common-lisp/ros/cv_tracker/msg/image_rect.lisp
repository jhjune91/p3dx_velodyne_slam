...
(cl:defmethod cl:initialize-instance :after ((m <image_rect>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'image_rect)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cv_tracker-msg:<image_rect> is deprecated: use cv_tracker-msg:image_rect instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <image_rect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_tracker-msg:x-val is deprecated.  Use cv_tracker-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <image_rect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_tracker-msg:y-val is deprecated.  Use cv_tracker-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <image_rect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_tracker-msg:height-val is deprecated.  Use cv_tracker-msg:height instead.")
  (height m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <image_rect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_tracker-msg:width-val is deprecated.  Use cv_tracker-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <image_rect>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_tracker-msg:score-val is deprecated.  Use cv_tracker-msg:score instead.")
  (score m))
