...
(cl:defclass <TunedResult> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (Red
    :reader Red
    :initarg :Red
    :type road_wizard-msg:ColorSet
    :initform (cl:make-instance 'road_wizard-msg:ColorSet))
   (Yellow
    :reader Yellow
    :initarg :Yellow
    :type road_wizard-msg:ColorSet
...
(cl:defmethod cl:initialize-instance :after ((m <TunedResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TunedResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name road_wizard-msg:<TunedResult> is deprecated: use road_wizard-msg:TunedResult instead.")))
...
(cl:defmethod Red-val ((m <TunedResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader road_wizard-msg:Red-val is deprecated.  Use road_wizard-msg:Red instead.")
  (Red m))

(cl:ensure-generic-function 'Yellow-val :lambda-list '(m))
(cl:defmethod Yellow-val ((m <TunedResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader road_wizard-msg:Yellow-val is deprecated.  Use road_wizard-msg:Yellow instead.")
  (Yellow m))

(cl:ensure-generic-function 'Green-val :lambda-list '(m))
(cl:defmethod Green-val ((m <TunedResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader road_wizard-msg:Green-val is deprecated.  Use road_wizard-msg:Green instead.")
  (Green m))
