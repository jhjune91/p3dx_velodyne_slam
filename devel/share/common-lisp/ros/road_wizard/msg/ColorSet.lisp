...
(cl:defclass <ColorSet> (roslisp-msg-protocol:ros-message)
  ((Hue
    :reader Hue
    :initarg :Hue
    :type road_wizard-msg:ValueSet
    :initform (cl:make-instance 'road_wizard-msg:ValueSet))
   (Sat
    :reader Sat
    :initarg :Sat
    :type road_wizard-msg:ValueSet
...
(cl:defmethod cl:initialize-instance :after ((m <ColorSet>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ColorSet)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name road_wizard-msg:<ColorSet> is deprecated: use road_wizard-msg:ColorSet instead.")))

(cl:ensure-generic-function 'Hue-val :lambda-list '(m))
(cl:defmethod Hue-val ((m <ColorSet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader road_wizard-msg:Hue-val is deprecated.  Use road_wizard-msg:Hue instead.")
  (Hue m))

(cl:ensure-generic-function 'Sat-val :lambda-list '(m))
(cl:defmethod Sat-val ((m <ColorSet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader road_wizard-msg:Sat-val is deprecated.  Use road_wizard-msg:Sat instead.")
  (Sat m))

(cl:ensure-generic-function 'Val-val :lambda-list '(m))
(cl:defmethod Val-val ((m <ColorSet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader road_wizard-msg:Val-val is deprecated.  Use road_wizard-msg:Val instead.")
  (Val m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ColorSet>)))
  ...
  (cl:format cl:nil "ValueSet Hue~%ValueSet Sat~%ValueSet Val~%~%================================================================================~%MSG: road_wizard/ValueSet~%int32 center~%int32 range~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ColorSet)))
  "Returns full string definition for message of type 'ColorSet"
  (cl:format cl:nil "ValueSet Hue~%ValueSet Sat~%ValueSet Val~%~%================================================================================~%MSG: road_wizard/ValueSet~%int32 center~%int32 range~%~%~%"))
