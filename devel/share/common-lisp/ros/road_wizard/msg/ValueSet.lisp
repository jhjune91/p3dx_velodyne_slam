...
(cl:defmethod cl:initialize-instance :after ((m <ValueSet>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ValueSet)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name road_wizard-msg:<ValueSet> is deprecated: use road_wizard-msg:ValueSet instead.")))

(cl:ensure-generic-function 'center-val :lambda-list '(m))
(cl:defmethod center-val ((m <ValueSet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader road_wizard-msg:center-val is deprecated.  Use road_wizard-msg:center instead.")
  (center m))

(cl:ensure-generic-function 'range-val :lambda-list '(m))
(cl:defmethod range-val ((m <ValueSet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader road_wizard-msg:range-val is deprecated.  Use road_wizard-msg:range instead.")
  (range m))
