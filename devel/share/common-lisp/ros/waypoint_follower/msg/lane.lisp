...
(cl:defclass <lane> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (waypoints
    :reader waypoints
    :initarg :waypoints
    :type (cl:vector waypoint_follower-msg:waypoint)
   :initform (cl:make-array 0 :element-type 'waypoint_follower-msg:waypoint :initial-element (cl:make-instance 'waypoint_follower-msg:waypoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <lane>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lane)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name waypoint_follower-msg:<lane> is deprecated: use waypoint_follower-msg:lane instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waypoint_follower-msg:header-val is deprecated.  Use waypoint_follower-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'increment-val :lambda-list '(m))
(cl:defmethod increment-val ((m <lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waypoint_follower-msg:increment-val is deprecated.  Use waypoint_follower-msg:increment instead.")
  (increment m))

(cl:ensure-generic-function 'waypoints-val :lambda-list '(m))
(cl:defmethod waypoints-val ((m <lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waypoint_follower-msg:waypoints-val is deprecated.  Use waypoint_follower-msg:waypoints instead.")
  (waypoints m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <lane>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'waypoints)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'waypoint_follower-msg:waypoint))
