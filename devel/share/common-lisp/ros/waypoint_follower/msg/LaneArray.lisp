...
(cl:defclass <LaneArray> (roslisp-msg-protocol:ros-message)
  ((lanes
    :reader lanes
    :initarg :lanes
    :type (cl:vector waypoint_follower-msg:lane)
   :initform (cl:make-array 0 :element-type 'waypoint_follower-msg:lane :initial-element (cl:make-instance 'waypoint_follower-msg:lane))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LaneArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LaneArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name waypoint_follower-msg:<LaneArray> is deprecated: use waypoint_follower-msg:LaneArray instead.")))

(cl:ensure-generic-function 'lanes-val :lambda-list '(m))
(cl:defmethod lanes-val ((m <LaneArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waypoint_follower-msg:lanes-val is deprecated.  Use waypoint_follower-msg:lanes instead.")
  (lanes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LaneArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'lanes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'waypoint_follower-msg:lane))
