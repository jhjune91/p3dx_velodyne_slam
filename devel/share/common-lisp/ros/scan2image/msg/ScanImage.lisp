...
(cl:defmethod cl:initialize-instance :after ((m <ScanImage>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ScanImage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name scan2image-msg:<ScanImage> is deprecated: use scan2image-msg:ScanImage instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ScanImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scan2image-msg:header-val is deprecated.  Use scan2image-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <ScanImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scan2image-msg:distance-val is deprecated.  Use scan2image-msg:distance instead.")
  (distance m))

(cl:ensure-generic-function 'intensity-val :lambda-list '(m))
(cl:defmethod intensity-val ((m <ScanImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scan2image-msg:intensity-val is deprecated.  Use scan2image-msg:intensity instead.")
  (intensity m))

(cl:ensure-generic-function 'max_y-val :lambda-list '(m))
(cl:defmethod max_y-val ((m <ScanImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scan2image-msg:max_y-val is deprecated.  Use scan2image-msg:max_y instead.")
  (max_y m))

(cl:ensure-generic-function 'min_y-val :lambda-list '(m))
(cl:defmethod min_y-val ((m <ScanImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scan2image-msg:min_y-val is deprecated.  Use scan2image-msg:min_y instead.")
  (min_y m))
