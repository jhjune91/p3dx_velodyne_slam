// Generated by gencpp from file synchronization/time_monitor.msg
// DO NOT EDIT!


#ifndef SYNCHRONIZATION_MESSAGE_TIME_MONITOR_H
#define SYNCHRONIZATION_MESSAGE_TIME_MONITOR_H
...
struct time_monitor_
{
  typedef time_monitor_<ContainerAllocator> Type;
  ...
  time_monitor_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , image_raw(0.0)
    , points_raw(0.0)
    , points_image(0.0)
  ...
  typedef boost::shared_ptr< ::synchronization::time_monitor_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::synchronization::time_monitor_<ContainerAllocator> const> ConstPtr;

}; // struct time_monitor_

typedef ::synchronization::time_monitor_<std::allocator<void> > time_monitor;

typedef boost::shared_ptr< ::synchronization::time_monitor > time_monitorPtr;
typedef boost::shared_ptr< ::synchronization::time_monitor const> time_monitorConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::synchronization::time_monitor_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::synchronization::time_monitor_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::synchronization::time_monitor_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::synchronization::time_monitor_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::synchronization::time_monitor_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::synchronization::time_monitor_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::synchronization::time_monitor_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::synchronization::time_monitor_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::synchronization::time_monitor_<ContainerAllocator> >
{
  ...
  static const char* value(const ::synchronization::time_monitor_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8c6a4dd195d4ccc3ULL;
  static const uint64_t static_value2 = 0x1d38fad617327689ULL;
};

template<class ContainerAllocator>
struct DataType< ::synchronization::time_monitor_<ContainerAllocator> >
{
  static const char* value()
  {
    return "synchronization/time_monitor";
  }
...
template<class ContainerAllocator>
struct Definition< ::synchronization::time_monitor_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::synchronization::time_monitor_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::synchronization::time_monitor_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::synchronization::time_monitor_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // SYNCHRONIZATION_MESSAGE_TIME_MONITOR_H
