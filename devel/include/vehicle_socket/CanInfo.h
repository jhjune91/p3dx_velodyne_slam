// Generated by gencpp from file vehicle_socket/CanInfo.msg
// DO NOT EDIT!


#ifndef VEHICLE_SOCKET_MESSAGE_CANINFO_H
#define VEHICLE_SOCKET_MESSAGE_CANINFO_H
...
struct CanInfo_
{
  ...
  typedef boost::shared_ptr< ::vehicle_socket::CanInfo_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::vehicle_socket::CanInfo_<ContainerAllocator> const> ConstPtr;

}; // struct CanInfo_

typedef ::vehicle_socket::CanInfo_<std::allocator<void> > CanInfo;

typedef boost::shared_ptr< ::vehicle_socket::CanInfo > CanInfoPtr;
typedef boost::shared_ptr< ::vehicle_socket::CanInfo const> CanInfoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::vehicle_socket::CanInfo_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::vehicle_socket::CanInfo_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
// {'vehicle_socket': ['/home/hj/catkin_ws/src/socket/packages/vehicle_socket/msg'], 'std_msgs': ['/opt/ros/indigo/share/std_msgs/cmake/../msg']}
...
template <class ContainerAllocator>
struct IsFixedSize< ::vehicle_socket::CanInfo_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::vehicle_socket::CanInfo_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::vehicle_socket::CanInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::vehicle_socket::CanInfo_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::vehicle_socket::CanInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::vehicle_socket::CanInfo_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::vehicle_socket::CanInfo_<ContainerAllocator> >
{
  ...
  static const char* value(const ::vehicle_socket::CanInfo_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x605f4356821f92a8ULL;
  static const uint64_t static_value2 = 0xfec1a756259316dfULL;
};

template<class ContainerAllocator>
struct DataType< ::vehicle_socket::CanInfo_<ContainerAllocator> >
{
  static const char* value()
  {
    return "vehicle_socket/CanInfo";
  }
...
template<class ContainerAllocator>
struct Definition< ::vehicle_socket::CanInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::vehicle_socket::CanInfo_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::vehicle_socket::CanInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::vehicle_socket::CanInfo_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // VEHICLE_SOCKET_MESSAGE_CANINFO_H
