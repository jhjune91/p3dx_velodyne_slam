// Generated by gencpp from file runtime_manager/ConfigRcnn.msg
// DO NOT EDIT!


#ifndef RUNTIME_MANAGER_MESSAGE_CONFIGRCNN_H
#define RUNTIME_MANAGER_MESSAGE_CONFIGRCNN_H
...
struct ConfigRcnn_
{
  ...
  typedef boost::shared_ptr< ::runtime_manager::ConfigRcnn_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::runtime_manager::ConfigRcnn_<ContainerAllocator> const> ConstPtr;

}; // struct ConfigRcnn_

typedef ::runtime_manager::ConfigRcnn_<std::allocator<void> > ConfigRcnn;

typedef boost::shared_ptr< ::runtime_manager::ConfigRcnn > ConfigRcnnPtr;
typedef boost::shared_ptr< ::runtime_manager::ConfigRcnn const> ConfigRcnnConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::runtime_manager::ConfigRcnn_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::runtime_manager::ConfigRcnn_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::runtime_manager::ConfigRcnn_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::runtime_manager::ConfigRcnn_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::runtime_manager::ConfigRcnn_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::runtime_manager::ConfigRcnn_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::runtime_manager::ConfigRcnn_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::runtime_manager::ConfigRcnn_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::runtime_manager::ConfigRcnn_<ContainerAllocator> >
{
  ...
  static const char* value(const ::runtime_manager::ConfigRcnn_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xf51f68bdedfbe5daULL;
  static const uint64_t static_value2 = 0x5d10ace3c7a60ff0ULL;
};

template<class ContainerAllocator>
struct DataType< ::runtime_manager::ConfigRcnn_<ContainerAllocator> >
{
  static const char* value()
  {
    return "runtime_manager/ConfigRcnn";
  }
...
template<class ContainerAllocator>
struct Definition< ::runtime_manager::ConfigRcnn_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::runtime_manager::ConfigRcnn_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::runtime_manager::ConfigRcnn_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::runtime_manager::ConfigRcnn_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // RUNTIME_MANAGER_MESSAGE_CONFIGRCNN_H
