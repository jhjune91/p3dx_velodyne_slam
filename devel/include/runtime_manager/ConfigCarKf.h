// Generated by gencpp from file runtime_manager/ConfigCarKf.msg
// DO NOT EDIT!


#ifndef RUNTIME_MANAGER_MESSAGE_CONFIGCARKF_H
#define RUNTIME_MANAGER_MESSAGE_CONFIGCARKF_H
...
struct ConfigCarKf_
{
  ...
  typedef boost::shared_ptr< ::runtime_manager::ConfigCarKf_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::runtime_manager::ConfigCarKf_<ContainerAllocator> const> ConstPtr;

}; // struct ConfigCarKf_

typedef ::runtime_manager::ConfigCarKf_<std::allocator<void> > ConfigCarKf;

typedef boost::shared_ptr< ::runtime_manager::ConfigCarKf > ConfigCarKfPtr;
typedef boost::shared_ptr< ::runtime_manager::ConfigCarKf const> ConfigCarKfConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::runtime_manager::ConfigCarKf_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::runtime_manager::ConfigCarKf_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::runtime_manager::ConfigCarKf_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::runtime_manager::ConfigCarKf_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::runtime_manager::ConfigCarKf_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::runtime_manager::ConfigCarKf_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::runtime_manager::ConfigCarKf_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::runtime_manager::ConfigCarKf_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::runtime_manager::ConfigCarKf_<ContainerAllocator> >
{
  ...
  static const char* value(const ::runtime_manager::ConfigCarKf_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x35fb5980cbba7f23ULL;
  static const uint64_t static_value2 = 0x7457ede929c58aa9ULL;
};

template<class ContainerAllocator>
struct DataType< ::runtime_manager::ConfigCarKf_<ContainerAllocator> >
{
  static const char* value()
  {
    return "runtime_manager/ConfigCarKf";
  }
...
template<class ContainerAllocator>
struct Definition< ::runtime_manager::ConfigCarKf_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::runtime_manager::ConfigCarKf_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::runtime_manager::ConfigCarKf_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::runtime_manager::ConfigCarKf_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // RUNTIME_MANAGER_MESSAGE_CONFIGCARKF_H
