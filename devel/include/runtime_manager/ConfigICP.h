// Generated by gencpp from file runtime_manager/ConfigICP.msg
// DO NOT EDIT!


#ifndef RUNTIME_MANAGER_MESSAGE_CONFIGICP_H
#define RUNTIME_MANAGER_MESSAGE_CONFIGICP_H
...
struct ConfigICP_
{
  ...
  typedef boost::shared_ptr< ::runtime_manager::ConfigICP_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::runtime_manager::ConfigICP_<ContainerAllocator> const> ConstPtr;

}; // struct ConfigICP_

typedef ::runtime_manager::ConfigICP_<std::allocator<void> > ConfigICP;

typedef boost::shared_ptr< ::runtime_manager::ConfigICP > ConfigICPPtr;
typedef boost::shared_ptr< ::runtime_manager::ConfigICP const> ConfigICPConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::runtime_manager::ConfigICP_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::runtime_manager::ConfigICP_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::runtime_manager::ConfigICP_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::runtime_manager::ConfigICP_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::runtime_manager::ConfigICP_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::runtime_manager::ConfigICP_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::runtime_manager::ConfigICP_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::runtime_manager::ConfigICP_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::runtime_manager::ConfigICP_<ContainerAllocator> >
{
  ...
  static const char* value(const ::runtime_manager::ConfigICP_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5447e477cc209f1aULL;
  static const uint64_t static_value2 = 0xaba7597ea7741dc8ULL;
};

template<class ContainerAllocator>
struct DataType< ::runtime_manager::ConfigICP_<ContainerAllocator> >
{
  static const char* value()
  {
    return "runtime_manager/ConfigICP";
  }
...
template<class ContainerAllocator>
struct Definition< ::runtime_manager::ConfigICP_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::runtime_manager::ConfigICP_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::runtime_manager::ConfigICP_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::runtime_manager::ConfigICP_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // RUNTIME_MANAGER_MESSAGE_CONFIGICP_H
