// Generated by gencpp from file runtime_manager/ConfigPoints2Polygon.msg
// DO NOT EDIT!


#ifndef RUNTIME_MANAGER_MESSAGE_CONFIGPOINTS2POLYGON_H
#define RUNTIME_MANAGER_MESSAGE_CONFIGPOINTS2POLYGON_H
...
struct ConfigPoints2Polygon_
{
  ...
  typedef boost::shared_ptr< ::runtime_manager::ConfigPoints2Polygon_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::runtime_manager::ConfigPoints2Polygon_<ContainerAllocator> const> ConstPtr;

}; // struct ConfigPoints2Polygon_

typedef ::runtime_manager::ConfigPoints2Polygon_<std::allocator<void> > ConfigPoints2Polygon;

typedef boost::shared_ptr< ::runtime_manager::ConfigPoints2Polygon > ConfigPoints2PolygonPtr;
typedef boost::shared_ptr< ::runtime_manager::ConfigPoints2Polygon const> ConfigPoints2PolygonConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::runtime_manager::ConfigPoints2Polygon_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::runtime_manager::ConfigPoints2Polygon_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::runtime_manager::ConfigPoints2Polygon_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::runtime_manager::ConfigPoints2Polygon_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::runtime_manager::ConfigPoints2Polygon_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::runtime_manager::ConfigPoints2Polygon_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::runtime_manager::ConfigPoints2Polygon_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::runtime_manager::ConfigPoints2Polygon_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::runtime_manager::ConfigPoints2Polygon_<ContainerAllocator> >
{
  ...
  static const char* value(const ::runtime_manager::ConfigPoints2Polygon_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x9b14a69dff1a04a7ULL;
  static const uint64_t static_value2 = 0x36a3b125792a41bfULL;
};

template<class ContainerAllocator>
struct DataType< ::runtime_manager::ConfigPoints2Polygon_<ContainerAllocator> >
{
  static const char* value()
  {
    return "runtime_manager/ConfigPoints2Polygon";
  }
...
template<class ContainerAllocator>
struct Definition< ::runtime_manager::ConfigPoints2Polygon_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::runtime_manager::ConfigPoints2Polygon_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::runtime_manager::ConfigPoints2Polygon_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::runtime_manager::ConfigPoints2Polygon_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // RUNTIME_MANAGER_MESSAGE_CONFIGPOINTS2POLYGON_H
