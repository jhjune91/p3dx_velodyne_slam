...
"""autogenerated by genpy from scan2image/ScanImage.msg. Do not edit."""
import sys
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2i.pack(_x.max_y, _x.min_y))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.max_y, _x.min_y,) = _struct_2i.unpack(str[start:end])
      return self
