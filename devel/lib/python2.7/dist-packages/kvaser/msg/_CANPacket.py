...
"""autogenerated by genpy from kvaser/CANPacket.msg. Do not edit."""
import sys
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2IB.pack(_x.count, _x.id, _x.len))
      _x = self.dat
      ...
      _x = self
      buff.write(_struct_HI.pack(_x.flag, _x.time))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.count, _x.id, _x.len,) = _struct_2IB.unpack(str[start:end])
      start = end
      end += 8
      ...
      (_x.flag, _x.time,) = _struct_HI.unpack(str[start:end])
      return self
