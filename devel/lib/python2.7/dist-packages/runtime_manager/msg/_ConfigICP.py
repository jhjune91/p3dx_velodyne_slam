...
"""autogenerated by genpy from runtime_manager/ConfigICP.msg. Do not edit."""
import sys
...
class ConfigICP(genpy.Message):
  ...
  _type = "runtime_manager/ConfigICP"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_i6fifi4f.pack(_x.init_pos_gnss, _x.x, _x.y, _x.z, _x.roll, _x.pitch, _x.yaw, _x.use_predict_pose, _x.error_threshold, _x.maximum_iterations, _x.transformation_epsilon, _x.max_correspondence_distance, _x.euclidean_fitness_epsilon, _x.ransac_outlier_rejection_threshold))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.init_pos_gnss, _x.x, _x.y, _x.z, _x.roll, _x.pitch, _x.yaw, _x.use_predict_pose, _x.error_threshold, _x.maximum_iterations, _x.transformation_epsilon, _x.max_correspondence_distance, _x.euclidean_fitness_epsilon, _x.ransac_outlier_rejection_threshold,) = _struct_i6fifi4f.unpack(str[start:end])
      return self
