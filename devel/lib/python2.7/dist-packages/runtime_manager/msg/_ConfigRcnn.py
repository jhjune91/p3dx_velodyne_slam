...
"""autogenerated by genpy from runtime_manager/ConfigRcnn.msg. Do not edit."""
import sys
...
class ConfigRcnn(genpy.Message):
  ...
  _type = "runtime_manager/ConfigRcnn"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_6f3B.pack(_x.score_threshold, _x.group_threshold, _x.slices_overlap, _x.b_mean, _x.g_mean, _x.r_mean, _x.image_slices, _x.use_gpu, _x.gpu_device_id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.score_threshold, _x.group_threshold, _x.slices_overlap, _x.b_mean, _x.g_mean, _x.r_mean, _x.image_slices, _x.use_gpu, _x.gpu_device_id,) = _struct_6f3B.unpack(str[start:end])
      return self
