...
"""autogenerated by genpy from runtime_manager/ConfigPedestrianKf.msg. Do not edit."""
import sys
...
class ConfigPedestrianKf(genpy.Message):
  ...
  _type = "runtime_manager/ConfigPedestrianKf"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2i4f2i.pack(_x.initial_lifespan, _x.default_lifespan, _x.noise_covariance, _x.measurement_noise_covariance, _x.error_estimate_covariance, _x.percentage_of_overlapping, _x.orb_features, _x.use_orb))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.initial_lifespan, _x.default_lifespan, _x.noise_covariance, _x.measurement_noise_covariance, _x.error_estimate_covariance, _x.percentage_of_overlapping, _x.orb_features, _x.use_orb,) = _struct_2i4f2i.unpack(str[start:end])
      return self
