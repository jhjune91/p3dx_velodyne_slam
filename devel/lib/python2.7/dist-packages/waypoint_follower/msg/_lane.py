...
"""autogenerated by genpy from waypoint_follower/lane.msg. Do not edit."""
import sys
...
class lane(genpy.Message):
  _md5sum = "261462d438fc895bdf94163a0a9478a5"
  _type = "waypoint_follower/lane"
...
"""
  ...
  _slot_types = ['std_msgs/Header','int32','waypoint_follower/waypoint[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = waypoint_follower.msg.waypoint()
        _v14 = val1.pose
        _v15 = _v14.header
        start = end
        end += 4
