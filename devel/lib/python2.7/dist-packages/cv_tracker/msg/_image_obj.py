...
"""autogenerated by genpy from cv_tracker/image_obj.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','string','cv_tracker/image_rect[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = cv_tracker.msg.image_rect()
        _x = val1
        start = end
        end += 20
