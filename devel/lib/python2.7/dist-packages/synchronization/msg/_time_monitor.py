...
"""autogenerated by genpy from synchronization/time_monitor.msg. Do not edit."""
import sys
...
class time_monitor(genpy.Message):
  _md5sum = "8c6a4dd195d4ccc31d38fad617327689"
  _type = "synchronization/time_monitor"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(time_monitor, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_15d.pack(_x.image_raw, _x.points_raw, _x.points_image, _x.vscan_points, _x.vscan_image, _x.image_obj, _x.image_obj_ranged, _x.image_obj_tracked, _x.current_pose, _x.obj_label, _x.cluster_centroids, _x.obj_pose, _x.execution_time, _x.cycle_time, _x.time_diff))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.image_raw, _x.points_raw, _x.points_image, _x.vscan_points, _x.vscan_image, _x.image_obj, _x.image_obj_ranged, _x.image_obj_tracked, _x.current_pose, _x.obj_label, _x.cluster_centroids, _x.obj_pose, _x.execution_time, _x.cycle_time, _x.time_diff,) = _struct_15d.unpack(str[start:end])
      return self
